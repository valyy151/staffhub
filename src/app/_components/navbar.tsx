				...
				<NavigationMenuList>
					<NavigationMenuItem>
						<NavigationMenuLink
							...
							className={`bg-background hover:bg-accent hover:text-accent-foreground group inline-flex h-10 w-max items-center justify-center rounded-md px-4 py-2 text-sm font-medium transition-colors focus:outline-none disabled:pointer-events-none disabled:opacity-50 ${
								session?.user && 'bg-primary text-primary-foreground hover:text-primary-foreground hover:bg-primary/90'
							}`}>
