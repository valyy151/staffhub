...
export default function PersonalInfoCard({ employee }: { employee: StaffIdOutput }) {
	...
	const handleSubmit = (e: React.FormEvent) => {
		...
		updateMutation.mutate({ email, firstName, lastName, phone, address, id: employee?.id })
	}
				...
				<AlertDialog open>
					<AlertDialogContent>
						<AlertDialogHeader>
							...
							<AlertDialogDescription>Edit the employee's information below.</AlertDialogDescription>
						</AlertDialogHeader>
						<form onSubmit={handleSubmit}>
							<div className='space-y-2'>
								...
								<h2 className='font-bold pt-1'>Optional Fields</h2>
								<div className='space-y-2'>
