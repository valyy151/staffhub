export default function StaffSickVacationLoading() {
	return (
		<div className='flex flex-col'>
			<div className='flex justify-between'>
				<div className='h-11 rounded w-80 bg-muted animate-pulse' />
				<div className='h-11 rounded w-[9.2rem] bg-muted animate-pulse' />
			</div>
			...
			<div className='h-12 mt-12 mb-2 rounded w-56 bg-muted animate-pulse' />
